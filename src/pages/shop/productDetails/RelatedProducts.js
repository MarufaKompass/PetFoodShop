  ...
  return (
    <div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16">
          <h3 className="font-lato font-bold  text-heading  text-[28px]  mb-6">Related Products</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {relatedProducts.map((product) => (
              <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                />
                <div className="p-4">
                  <h4 className="font-lato font-bold  text-heading  text-[17px] mb-2">{product.name}</h4>
                  <p className="font-lato font-medium  text-semibold  text-[15px] ">{product.price} BDT</p>
