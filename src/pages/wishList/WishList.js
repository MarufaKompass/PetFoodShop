  ...
  const products = [
    {
      ...
      inStock: true,
      description: "Comfortable over-ear headphones with noise-canceling feature and long battery life.",
      image: cart1,
    },
    {
      id: 2,
      ...
      inStock: true,
      description: "Durable, eco-friendly water bottle with double-wall insulation to keep beverages cold or hot.",
      image: cart2,
    },
    {
      id: 3,
      ...
      category: "Furniture",
      inStock: false,
      description: "Adjustable office chair with lumbar support and breathable mesh backrest.",
      image: cart3,
    },
  ];
